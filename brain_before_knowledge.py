...
class MJBrain:
    ...
    def _should_process_as_screen(
        ...
        app_commands = {
            ...
            'paint kholo':'paint',
            'chrome kholo':'chrome',
            'whatsapp kholo':'whatsapp',
            'whatsapp open':'whatsapp',
            'telegram kholo':'telegram',
            'discord kholo':'discord',
            'word kholo':'word',
            'excel kholo':'excel',
        }
        ...
        if any(x in cmd for x in screen_words):
            return {
                'type':'SCREEN',
                'target':cmd
            }
    ...
    def smart_command_router(self, command):
        ...
        for key, target in app_targets.items():

            if key in command and 'band' not in command and 'close' not in command:
